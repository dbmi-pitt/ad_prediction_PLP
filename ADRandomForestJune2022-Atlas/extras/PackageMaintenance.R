...
#
# This file is part of ADRandomForestJune2022
#
...
OhdsiRTools::checkUsagePackage("ADRandomForestJune2022")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/ADRandomForestJune2022.pdf")
shell("R CMD Rd2pdf ./ --output=extras/ADRandomForestJune2022.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "ADRandomForestJune2022")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("ADRandomForestJune2022")
