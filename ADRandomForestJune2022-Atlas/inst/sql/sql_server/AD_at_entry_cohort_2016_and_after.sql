...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (378419,4182210,43530666,378125,381832,44782771,377527,4218017,4220313,376946,380986,379784,376085,375791)
...
WHERE C.condition_start_date >= DATEFROMPARTS(2016, 01, 01)
