...
Vignette: [Using the package skeleton for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/StudyProtocolSandbox/master/ADRandomForestJune2022/inst/doc/UsingSkeletonPackage.pdf)

For information on how to generate shiny apps using the R skeleton package see: [Creating shiny app for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/PatientLevelPrediction/testcode/inst/doc/CreatingShinyApp.pdf).  To combine multiple skeleton package results into a single shiny app [see populate multiple shiny app R code code](https://github.com/OHDSI/StudyProtocolSandbox/blob/master/ADRandomForestJune2022/extras/populateMultipleShiny.R)

For information on adding custom covariates based on ATLAS cohorts see:  [Adding custom covariates using ATLAS cohorts](https://raw.githubusercontent.com/OHDSI/StudyProtocolSandbox/master/ADRandomForestJune2022/inst/doc/AddingCohortCovariates.pdf).
...
outputFolder <- "./ADRandomForestJune2022Results"
...
cohortTable <- 'ADRandomForestJune2022Cohort'
#=======================
...
```r
  ...
  devtools::install_github("ohdsi-studies/ADRandomForestJune2022")
```
